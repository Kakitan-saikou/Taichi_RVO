...
MR = Solver('L-BFGS', [1000, 1000], 3, 5.0, 1.0, accuracy='f32', substeps=1, control_freq=10, control='velocity')
...
for frame in range(1000):
    ...
    if substeps % 120 == 0:
        MR.add_crafts_dynamic(craft_type, craft_camp, x, combined_actions, length, width, None)
