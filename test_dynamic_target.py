...
MR = Solver('L-BFGS', [1000, 1000], 3, 5.0, 1.0, accuracy='f32', substeps=1, control_freq=10, control='target')
...
for frame in range(1000):
    ...
    print(MR.global_E[None]/MR.n_active[None])
    substeps += substep
